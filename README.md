# Prometheus stack for Wodby

Deploy Prometheus on Kubernetes with Wodby. This repository contains the stack
manifests used by the public Prometheus stack in the Wodby catalog.
